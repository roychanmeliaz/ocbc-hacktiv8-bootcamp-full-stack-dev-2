...
for num in numbers:
    ...
    if num==918:
        break
    # dibawah ini pemenuhan assignment objectives:
    # mengimpelementasikan else (poin 4), dan continue (poin 3)
    # dipake oke, ngga dipake juga gapapa. Cuma untuk objectives
    else:
      	continue
